...
// import Image from "next/image"; // Keep commented out until standard img is perfect
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* REMOVED: 3. SPOTLIGHT (The warm radial glow) */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="mb-20 flex flex-col items-center text-center">
          <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-[#ff8a3c]/20 bg-[#ff8a3c]/5 px-4 py-1.5 backdrop-blur-md">
            {/* REMOVED: shadow-[0_0_10px_#ff8a3c] from this span */}
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s, i) => (
            <ServiceCard key={i} index={i} title={s.title} body={s.body} />
          ))}
        </div>
          ...
          <div className="flex flex-col gap-10 p-8 lg:flex-row lg:items-center lg:justify-between lg:p-12">
            <div className="max-w-xl space-y-4">
              ...
              <p className="text-zinc-400">
                Emme vain "tee sivuja". Me rakennamme suorituskykyä. Jos
                sivustosi Google Lighthouse -arvosana (Performance) ei ole
                vihreällä (<span className="text-[#4ade80]">90+</span>)
                julkaisuhetkellä, jatkamme optimointia veloituksetta.
              </p>
            </div>
                ...
                <div className="relative h-20 w-20">
                  ...
                  >
                    ...
                    <path
                      ...
                      strokeDasharray={isHoveringHook ? "98, 100" : "0, 100"}
                      d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="3"
...
function ServiceCard({
  ...
  // REMOVED: hover:shadow-[0_10px_40px_-10px_rgba(255,138,60,0.1)]
  return (
    <article className="group relative flex flex-col justify-between overflow-hidden rounded-sm border border-[#ff8a3c]/10 bg-[#0a0b10]/90 p-8 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#ff8a3c]/40 hover:bg-[#120b08]">
      <span
        style={{ fontFamily: "var(--font-goldman)" }}
